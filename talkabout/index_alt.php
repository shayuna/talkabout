...
<img id="dialogue" src="./images/dialogue.jpg"/>
<div id="tolkaboutHdr">
    <span id="logo">Tolkabout</span>
...
*/
    ...
    function adjustScrn()
    {
       ...
       {
            $("#dialogue").css("height",getWndHeight()+"px");
            $("#btmMargin").css("height",parseInt(getWndHeight()-$("#btmMargin").attr("offsetTop"),10)+"px");
       }
       else
       {
            $("#dialogue").css("height",parseInt($("#ftr").attr("offsetTop")+$("#ftr").attr("offsetHeight"),10)+"px");
            $("#btmMargin").css("height","0");
       }
       $("#dialogue").css("width",parseInt($(window).width()-5,10)+"px");
    }
    function onLoad()
    {
